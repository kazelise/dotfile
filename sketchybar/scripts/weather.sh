...
API="https://api.weatherapi.com/v1/current.json?key=ace7cdd90a3340cf8f514106251104&q=sydney&aqi=no
"
...
sketchybar --set $NAME drawing=on icon=$icon label="${temp%%.*}°F"# --set weather.location label="Location: $city"# --set weather.feels_like label="Feels Like: $feelslike°F"# --set weather.humidity label="Humidity: $humidity%"# --set weather.lastupdated label="Last Updated: $(gdate +%T # \
